<%@ Page Title="Todo Details" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TodoDetails.aspx.cs" Inherits="COMP2007_S2016_MidTerm_200305245.TodoDetails" %>
        ...
        <div class="row">
            <div class="col-md-offset-3 col-md-6">
                ...
                <div class="text-left">
                    ...
                    <asp:CheckBox  Text="Completed" runat="server" ID="CompletedCheckBox" CssClass="AcceptedAgreement"  />
